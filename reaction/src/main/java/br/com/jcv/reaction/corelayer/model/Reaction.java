...
public class Reaction {
    ...
    @Column(name = "tx_name")
    @CodeGeneratorFieldDescriptor(fieldDescription = "Reaction name")
    private String name;

    @Column(name = "tx_icon")
    @CodeGeneratorFieldDescriptor(fieldDescription = "Reaction icon")
    private String icon;

    @Column(name = "tx_tag")
    @CodeGeneratorFieldDescriptor(fieldDescription = "Reaction tag")
    private String tag;
