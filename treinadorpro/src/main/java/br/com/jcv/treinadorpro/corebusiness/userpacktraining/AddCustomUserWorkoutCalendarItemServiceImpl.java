...
@Service
public class AddCustomUserWorkoutCalendarItemServiceImpl implements AddCustomUserWorkoutCalendarItemService {
    ...
    public AddCustomUserWorkoutCalendarItemServiceImpl(UserWorkoutCalendarRepository userWorkoutCalendarRepository,
    ...
    @Override
    @Transactional
    public ControllerGenericResponse<Boolean> execute(UUID processId, AddCustomUserWorkoutCalendarItemRequest request) {

        UserWorkoutCalendar workoutCalendarItem = new UserWorkoutCalendar();
    ...
    private void map(AddCustomUserWorkoutCalendarItemRequest request, UserWorkoutCalendar workoutCalendarItem) {
        workoutCalendarItem.setTrainingDate(request.getTrainingDate());
        workoutCalendarItem.setExternalId(UUID.randomUUID());
