...
public class RegisterApplicationBusinessServiceImpl
    ...
    @Override
    public RegisterApplicationResponse execute(UUID processId, String jwtToken, RegisterApplicationRequest request) {
        askHeimdallPermission(jwtToken, RoleEnums.GUARDIAN_REGISTER_APPLICATION.name());
